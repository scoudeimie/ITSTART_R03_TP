 ...
 *
 * @param actif Vrai pour activer, faux pour dÈsactiver
 */
...
/**
 * Est appelÈe lorsque le contenu du champs de saisie est modifiÈ
 *
...
/** 
 * Envois un message vers le serveur pour y Ítre enregistrÈ
 */
function sendMessage() {
	$.post( "/tchat/php/index.php", 
	       ...
	       function( data ) { // Fonction de callback en cas de succËs
				if (data == "KO") {
					alert("votre message n'a pas ÈtÈ envoyÈ...");
				}	
		   }
	);
}